# Implementation based on Zeta library reference
# https://github.com/kyegomez/zeta/blob/7fca4c337105e9c3d2672804a7ecfc6d6a39eeb5/zeta/nn/modules/ssm.py

import torch
import torch.nn as nn
import torch.nn.functional as F

from model.modules.p_scan import pscan
...
def selective_scan(x, delta, A, B, C, D):
    ...
    _, L, _ = x.shape
    print(x.shape, delta.shape, A.shape, B.shape, C.shape, D.shape)
